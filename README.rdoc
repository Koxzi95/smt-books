...
{<img alt="Status?branch=master" src="https://codeship.io/projects/1004a4e0-39b8-0132-b4d8-7ea5f55f971f/status?branch=master" />}[https://codeship.io/projects/42247]
...
user to add, edit and delete book entries.
...
* The seed_dump gem is used for seed creation. Run rake db:seed:dump
