...
if count = Product.count > 0
  ...
  Product.create(:title => "Alice in Wonderland",:description => "Young Alice is sitting by the river bank with her older sister,
    ...
    :price => 7.50, :date_published => "1865-11-26")
    ...
    :price => 12.25 , :date_published => "1892-10-14")
    ...
    :price => 3.50, :date_published => "1813-1-28")
    ...
    :picture => 'hobbit.jpg' , :price => 3.50, :date_published => "1937-09-21")
    ...
    :picture => '2001-space-odessey.jpg' , :price => 11.50, :date_published => "1968-04-02" )
    ...
    :picture => 'asimov-series.jpg' , :price => 15.30, :date_published => "1954-06-01" )
    ...
    :picture => 'brave-new-world.jpg' , :price => 9.50, :date_published => "1932-01-01")
    ...
    Abraham van Helsing." ,
    :picture => 'dracula.jpg' , :price => 13.50, :date_published => "1897-05-26" )
    ...
    :picture => 'frankenstien.jpg' , :price => 12.50, :date_published => "1818-01-01" )
    ...
    :picture => 'great-expectations.jpg' , :price => 8.99, :date_published => "1860-12-01" )
    ...
    :picture => 'the-hitchhikers-guide.jpg' , :price => 17.50, :date_published => "1979-10-12" )
    ...
    :picture => 'sleeping-murder.jpg' , :price => 3.50, :date_published => "1976-10-1" )
    ...
    :picture => 'girl-with-the-dragon-tattoo.jpg' , :price => 12.98, :date_published => "2005-01-01" )
    ...
    :picture => 'hound-of-the-baskervilles.jpg' , :price => 7.50, :date_published => "1902-01-01" )
   ...
   inequality, evolution, and the relationship between science and society." ,
    :picture => 'time-machine.jpg' , :price => 5.75, :date_published => "1895-01-01")
    ...
    :picture => 'kill-a-mocking-bird.jpg' , :price => 9.50, :date_published => "1960-07-11")
